...
public class TextMethods {
    ...
    public void printHelp(boolean initiated) {
        if (!initiated) {
    ...
    public void printHelpSecond(boolean burntCompanion) {
        ...
        waitFor(200);
        typeWriterNormal("You can type 'help' at most points if you're confused. Try not to abuse it.");
        waitFor(6000);
        typeWriterNormal("... Any questions?");
        if (burntCompanion) {
